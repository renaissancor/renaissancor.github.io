...
## Comprehensive Vision Studio 

Used Stacks
React, Redux, RTK Query, Tailwind CSS, Ant Design 
...
Used Stacks
React, NextJS, Redux, RTK Query, Radix UI, Shadcn UI, React EChart, ApexChart 
...
Used Front End Stacks
React, NextJS, React Query, Radix UI, Shadcn UI, Eslint, Prettier 

Used Back End Stacks 
Python, Fast API 
